...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsBodyComponent = __webpack_require__(195);

	var _componentsBodyComponent2 = _interopRequireDefault(_componentsBodyComponent);

	var _componentsAboutComponent = __webpack_require__(202);

	var _componentsAboutComponent2 = _interopRequireDefault(_componentsAboutComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if ("production" !== ({"BROWSER":true}).NODE_ENV) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var injection = {
	  ...
	  injectMount: function(InjectedMount) {
	    ...
	    if ("production" !== ({"BROWSER":true}).NODE_ENV) {
	      ("production" !== ({"BROWSER":true}).NODE_ENV ? invariant(
...
/***/ function(module, exports, __webpack_require__) {
	...
	function mapSingleChildIntoContext(traverseContext, child, name, i) {
	  ...
	  if ("production" !== ({"BROWSER":true}).NODE_ENV) {
	    ("production" !== ({"BROWSER":true}).NODE_ENV ? warning(
	      keyUnique,
	  ...
	  for (var propName in propTypes) {
	    if (propTypes.hasOwnProperty(propName)) {
	      ...
	      if (error instanceof Error && !(error.message in loggedTypeFailures)) {
	        ...
	        ("production" !== ({"BROWSER":true}).NODE_ENV ? warning(false, 'Failed propType: %s%s', error.message, addendum) : null);
	      }
	    }
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOMPropertyOperations = {
	  ...
	  createMarkupForProperty: function(name, value) {
	    ...
	    } else if ("production" !== ({"BROWSER":true}).NODE_ENV) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Danger = {
	  ...
	  dangerouslyReplaceNodeWithMarkup: function(oldChild, markup) {
	    ...
	    ("production" !== ({"BROWSER":true}).NODE_ENV ? invariant(markup, 'dangerouslyReplaceNodeWithMarkup(...): Missing markup.') : invariant(markup));
	    ("production" !== ({"BROWSER":true}).NODE_ENV ? invariant(
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createNodesFromMarkup(markup, handleScript) {
	  var node = dummyNode;
	  ("production" !== ({"BROWSER":true}).NODE_ENV ? invariant(!!dummyNode, 'createNodesFromMarkup dummy not initialized') : invariant(!!dummyNode));
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getMarkupWrap(nodeName) {
	  ("production" !== ({"BROWSER":true}).NODE_ENV ? invariant(!!dummyNode, 'Markup wrapping node not initialized') : invariant(!!dummyNode));
...
/***/ function(module, exports, __webpack_require__) {
	...
	function validateDangerousTag(tag) {
	  if (!hasOwnProperty.call(validatedTagCache, tag)) {
	    ("production" !== ({"BROWSER":true}).NODE_ENV ? invariant(VALID_TAG_REGEX.test(tag), 'Invalid tag: %s', tag) : invariant(VALID_TAG_REGEX.test(tag)));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LocalEventTrapMixin = {
	  trapBubbledEvent:function(topLevelType, handlerBaseName) {
	    ("production" !== ({"BROWSER":true}).NODE_ENV ? invariant(this.isMounted(), 'Must be mounted to trap events') : invariant(this.isMounted()));
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.DefaultRoute = __webpack_require__(157);
	...
	exports.ActiveHandler = __webpack_require__(167);
	...
	exports.TestLocation = __webpack_require__(179);

	exports.ImitateBrowserBehavior = __webpack_require__(180);
	exports.ScrollToTopBehavior = __webpack_require__(181);

	exports.History = __webpack_require__(175);
	exports.Navigation = __webpack_require__(182);
	exports.State = __webpack_require__(183);
	...
	exports.createRoutesFromReactChildren = __webpack_require__(184);

	exports.create = __webpack_require__(185);
	exports.run = __webpack_require__(194);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var invariant = __webpack_require__(6);
	var warning = __webpack_require__(14);
	var PathUtils = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assign = __webpack_require__(12);
	var warning = __webpack_require__(14);
	var DefaultRoute = __webpack_require__(157);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var canUseDOM = __webpack_require__(50).canUseDOM;
	var LocationActions = __webpack_require__(174);
	var ImitateBrowserBehavior = __webpack_require__(180);
	...
	var ScrollHistory = __webpack_require__(186);
	var createRoutesFromReactChildren = __webpack_require__(184);
	var isReactChildren = __webpack_require__(188);
	var Transition = __webpack_require__(189);
	var PropTypes = __webpack_require__(158);
	var Redirect = __webpack_require__(191);
	var History = __webpack_require__(175);
	var Cancellation = __webpack_require__(190);
	var Match = __webpack_require__(192);
	var Route = __webpack_require__(159);
	var supportsHistory = __webpack_require__(193);
	var PathUtils = __webpack_require__(160);
	...
	function createRouter(options) {
	  ...
	  if (location instanceof StaticLocation) {
	    warning(!canUseDOM || ({"BROWSER":true}).NODE_ENV === 'test', 'You should not use a static location in a DOM environment because ' + 'the router will not be kept in sync with the current URL');
	  } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createRouter = __webpack_require__(185);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _leftSidebarComponent = __webpack_require__(196);

	var _leftSidebarComponent2 = _interopRequireDefault(_leftSidebarComponent);

	var _rightSidebarComponent = __webpack_require__(197);

	var _rightSidebarComponent2 = _interopRequireDefault(_rightSidebarComponent);
	...
	var BodyComponent = (function (_React$Component) {
	    ...
	    function BodyComponent() {
	        ...
	        _get(Object.getPrototypeOf(BodyComponent.prototype), "constructor", this).apply(this, arguments);
	    }
	        ...
	        value: function render() {
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    "div",
	                    { className: "row" },
	                    _react2["default"].createElement(_leftSidebarComponent2["default"], null),
	                    _react2["default"].createElement(_rightSidebarComponent2["default"], null),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LeftSidebarComponent = (function (_React$Component) {
	    _inherits(LeftSidebarComponent, _React$Component);

	    function LeftSidebarComponent() {
	        _classCallCheck(this, LeftSidebarComponent);

	        _get(Object.getPrototypeOf(LeftSidebarComponent.prototype), "constructor", this).apply(this, arguments);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RightSidebarComponent = (function (_React$Component) {
	    _inherits(RightSidebarComponent, _React$Component);

	    function RightSidebarComponent() {
	        _classCallCheck(this, RightSidebarComponent);

	        _get(Object.getPrototypeOf(RightSidebarComponent.prototype), "constructor", this).apply(this, arguments);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AboutComponent = (function (_React$Component) {
	    ...
	    function AboutComponent() {
	        ...
	        _get(Object.getPrototypeOf(AboutComponent.prototype), "constructor", this).apply(this, arguments);
	    }
